-- Fix: accept_defect_report RPC inserts priority as text instead of maintenance_priority enum.
-- The ->> operator extracts JSON values as text; Postgres cannot implicitly cast text to a
-- custom enum type. Add explicit ::maintenance_priority cast.
