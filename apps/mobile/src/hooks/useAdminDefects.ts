...
import { adminListDefectReports, bulkDeleteDefectReports } from '@rgr/shared/admin';
import type { AdminListDefectReportsParams } from '@rgr/shared/admin';
...
export const adminDefectKeys = {
  ...
  list: (params: AdminListDefectReportsParams) => [...adminDefectKeys.lists(), params] as const,
};
...
export function useBulkDeleteDefects() {
  return useMutationFromService({
    ...
    invalidates: [adminDefectKeys.all, defectKeys.lists(), defectKeys.stats()],
  });
}
