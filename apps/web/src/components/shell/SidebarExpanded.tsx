          ...
          <DropdownMenuTrigger className="flex w-full items-center gap-3 rounded-lg px-2 py-2 text-left outline-none hover:bg-white/[0.04] transition-colors">
            ...
            {user && (
              <div className="flex-1 min-w-0">
                <div className="text-sm font-medium text-white leading-tight truncate">{user.fullName}</div>
                <div className="text-[10px] text-white/40 uppercase tracking-wide leading-tight truncate">{user.role}</div>
              </div>
            )}
          </DropdownMenuTrigger>
