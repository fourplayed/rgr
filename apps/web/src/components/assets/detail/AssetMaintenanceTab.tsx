...
export const AssetMaintenanceTab = React.memo<AssetMaintenanceTabProps>(
  ({ assetId, isDark }) => {
      ...
      <div className="flex flex-col h-full">
        <div className="flex-1 overflow-y-auto">
          {records.map((record, i) => {
            const priorityColor = MaintenancePriorityColors[record.priority as MaintenancePriority] ?? '#6b7280';
            ...
            return (
              ...
              >
                <div className="flex items-start justify-between gap-2">
                  ...
                  >
                    {MaintenancePriorityLabels[record.priority as MaintenancePriority] ?? record.priority}
                  </span>
                </div>
