...
export const HazardReviewFilters = React.memo<HazardReviewFiltersProps>(
  ({ filters, onFiltersChange, className = '', isDark = true }) => {
                    ...
                    <button
                      ...
                      style={{
                        backgroundColor: isSelected
                          ...
                          : inputBg,
                        color: isSelected ? SEVERITY_COLORS[option.value] : textMuted,
              ...
              <div>
                ...
                <div className="relative">
                  <select
                    ...
                    onChange={(e) =>
                      onFiltersChange({ ...filters, status: e.target.value as ReviewStatus })
                    }
              ...
              <div>
                ...
                <div className="relative">
                  <select
                    ...
                    onChange={(e) =>
                      onFiltersChange({ ...filters, dateRange: e.target.value as DateRange })
                    }
                    className="w-full px-3 py-2 pr-8 rounded-lg text-sm transition-all duration-200 focus:outline-none focus:ring-2 appearance-none cursor-pointer"
                    style={
                      isDark
