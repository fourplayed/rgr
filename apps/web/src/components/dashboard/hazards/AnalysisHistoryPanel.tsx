...
export const AnalysisHistoryPanel = React.memo<AnalysisHistoryPanelProps>(
  ({ className = '', isDark = true, maxItems = 50 }) => {
            ...
            <div className="flex items-center gap-2">
              ...
              {!isLoading && (
                <span
                  ...
                  style={{ backgroundColor: inputBg, color: textMuted }}
                >
            ...
            <div className="flex items-center gap-4 mt-3 text-xs">
              {metrics.accuracyRate !== null && (
                <div
                  ...
                  style={{ color: metrics.accuracyRate >= 80 ? '#22c55e' : '#f59e0b' }}
                >
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <select
                ...
                onChange={(e) =>
                  setFilters((f) => ({
                    ...f,
                    reviewStatus: e.target.value as HistoryFilters['reviewStatus'],
                  }))
                }
                className="px-3 py-1.5 rounded-lg text-sm border focus:outline-none focus:ring-2 focus:ring-blue-500"
                style={{ backgroundColor: inputBg, borderColor, color: textPrimary }}
              ...
              <select
                ...
                onChange={(e) =>
                  setFilters((f) => ({
                    ...f,
                    accuracyFilter: e.target.value as HistoryFilters['accuracyFilter'],
                  }))
                }
                className="px-3 py-1.5 rounded-lg text-sm border focus:outline-none focus:ring-2 focus:ring-blue-500"
                style={{ backgroundColor: inputBg, borderColor, color: textPrimary }}
