...
export const AnalysisFeedbackPanel = React.memo<AnalysisFeedbackPanelProps>(
  ({ result, onFeedbackSubmitted, className = '', isDark = true }) => {
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2">
                <span
                  ...
                  style={{ backgroundColor: inputBg, color: textSecondary }}
                >
                    ...
                    >
                      ...
                      <div className="flex items-center gap-1 flex-shrink-0">
                        ...
                        <button
                          ...
                          style={{
                            backgroundColor:
                              hazardFeedback[hazard.id] === false
                                ? 'rgba(239, 68, 68, 0.2)'
                                : 'transparent',
                          }}
