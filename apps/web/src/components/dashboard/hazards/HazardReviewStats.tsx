...
export const HazardReviewStats = React.memo<HazardReviewStatsProps>(
  ({
    ...
    const totalHazards = Object.values(data.severityBreakdown).reduce(
      (sum, count) => sum + count,
      0
    );
    ...
    const borderColor = isDark ? `${RGR_COLORS.chrome.medium}33` : '#9ca3af'; // Gray-400 at 100% opacity for light theme
      ...
      <VisionCard className={className} isDark={isDark} noPadding>
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-xl font-medium" style={{ color: textPrimary }}>
                {title}
              </h3>
            ...
            <div className="space-y-1">
              <div className="flex items-center gap-1.5">
                <AlertTriangle
                  ...
                  style={{
                    color: data.pendingReviews > 0 ? RGR_COLORS.semantic.warningText : textMuted,
                  }}
                />
                <span className="text-sm font-medium" style={{ color: textSecondary }}>
                  Pending
              ...
              <div
                ...
                style={{
                  color: data.pendingReviews > 0 ? RGR_COLORS.semantic.warningText : textPrimary,
                }}
              >
                {data.pendingReviews}
              </div>
