...
export const AnalysisResultCard = React.memo<AnalysisResultCardProps>(
  ({ result, onAddToQueue, onDismiss, onNewAnalysis, className = '', isDark = true }) => {
    ...
    return (
      <VisionCard className={className} isDark={isDark} noPadding>
        {/* Card Header */}
        <div className="p-4 border-b flex-shrink-0" style={{ borderColor, background: headerBg }}>
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <Shield
                className="w-5 h-5"
                style={{ color: hasHighSeverity ? '#ef4444' : '#22c55e' }}
              />
        ...
        <div className="p-4 space-y-4">
            ...
            <div className="flex-1 min-w-0 space-y-2">
              <div className="flex items-center gap-2">
                ...
                <span
                  ...
                  style={{
                    backgroundColor:
                      result.freight.confidence >= 80
                        ? 'rgba(34, 197, 94, 0.15)'
                        : 'rgba(245, 158, 11, 0.15)',
                    color:
                      result.freight.confidence >= 80 ? '#22c55e' : RGR_COLORS.semantic.warningText,
                  }}
                >
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <AlertTriangle
                    className="w-4 h-4"
                    style={{ color: hasHighSeverity ? '#ef4444' : RGR_COLORS.semantic.warningText }}
                  />
                  <span className="text-sm font-semibold" style={{ color: textPrimary }}>
                ...
                <div className="flex gap-1.5">
                  {hazardCounts.critical > 0 && (
                    <span
                      ...
                      style={{
                        backgroundColor: SEVERITY_CONFIG.critical.bgOpacity,
                  ...
                  {hazardCounts.high > 0 && (
                    <span
                      className="px-1.5 py-0.5 rounded text-xs font-bold"
                      style={{
                        backgroundColor: SEVERITY_CONFIG.high.bgOpacity,
                  ...
                  {hazardCounts.medium > 0 && (
                    <span
                      className="px-1.5 py-0.5 rounded text-xs font-bold"
                      style={{
                        backgroundColor: SEVERITY_CONFIG.medium.bgOpacity,
                  ...
                  {hazardCounts.low > 0 && (
                    <span
                      className="px-1.5 py-0.5 rounded text-xs font-bold"
                      style={{
                        backgroundColor: SEVERITY_CONFIG.low.bgOpacity,
          ...
          <AnalysisFeedbackPanel result={result} isDark={isDark} />
