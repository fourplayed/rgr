    ...
    useEffect(() => {
      const fetchAssets = async () => {
        ...
        if (result.success) {
          ...
          setAssets([
            {
              id: '910472f2-2185-483a-ad70-87e55f46e2fe',
              assetNumber: 'TL001',
              category: 'trailer',
              subtype: 'flattop',
              status: 'serviced',
            ...
            {
              id: '937e0b87-8c68-43d3-8244-abcd0ad68be9',
              assetNumber: 'TL002',
              category: 'trailer',
              subtype: 'dropdeck',
              status: 'serviced',
            ...
            {
              id: '94cf231d-9804-4f1b-a01d-82d02f17b645',
              assetNumber: 'TL004',
              category: 'trailer',
              subtype: 'skel_trailer',
              status: 'serviced',
            },
            {
              id: 'e3e92532-032c-4a8e-825d-bc8af25102b0',
              assetNumber: 'TL005',
              category: 'trailer',
              subtype: 'extendable_flattop',
              status: 'serviced',
            },
            {
              id: 'e6858fe1-edab-4ada-abe7-65f853bc5a2d',
              assetNumber: 'DL001',
              category: 'dolly',
              subtype: null,
              status: 'serviced',
      ...
      <div className={`relative ${className}`}>
        ...
        {isOpen && (
          ...
          >
            ...
            {/* Optional hint */}
            <div className="px-3 py-2 text-xs border-t" style={{ borderColor, color: textMuted }}>
