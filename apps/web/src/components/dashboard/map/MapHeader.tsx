/**
 * MapHeader - Glassmorphic header bar that sits on top of the fleet map
 *
 * Contains search bar, zoom/fit controls, and a slide-down filter panel.
 * Styled to match login page input and button aesthetics.
 */
...
// Ordered in pairs for 2-column grid layout (left: Perth/Hed/New, right: Kar/Wub/Car)
const DEPOT_LOCATIONS = [
  ...
  { value: 'Newman', label: 'Newman', color: '#4d4dff' },
...
export const MapHeader = React.memo<MapHeaderProps>(({
  ...
  // Derive unique subtypes from assets
  ...
  // Input style matching login page ThemedInput
  ...
  // Filter pill button component — outline style with color accent
    ...
    <>
      ...
      >
        <style>{`
          ...
          /* Filter button permanent shimmer */
          .filter-btn-shimmer::after {
            animation: mapBtnShimmer 2s ease-in-out infinite !important;
          }
      ...
      {/* Filter panel - slides down from header, overlays map */}
      ...
      >
        ...
        <div className="flex flex-col gap-5">
          ...
          <div>
            ...
            <div className="filter-grid-locations" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '5px' }}>
          ...
          <div>
            ...
            <div className="filter-grid-status" style={{ display: 'inline-flex', flexDirection: 'column' as const, gap: '5px' }}>
