...
import { Truck, CheckCircle, Wrench, XCircle, Clock, MapPin, ChevronRight } from 'lucide-react';
...
export const RightSidePanel = React.memo<RightSidePanelProps>(
  ({ statistics, recentScans, quickActions, onEventClick, onViewAllActivity, className = '' }) => {
                ...
                >
                  ...
                  `}
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {/* Scanner */}
                      <p className={`text-xs mt-1 ${mutedColor}`}>Scanned by {event.scannerName}</p>
                    </div>
                  </div>
                </button>
              ))
