  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: 'radial-gradient(ellipse at top right, rgba(0, 117, 255, 0.4) 0%, transparent 70%)',
        }}
      />
      ...
      <div className="relative z-10 flex items-center justify-between gap-6">
        <div className="flex-1">
          ...
          <p className="text-vision-text-secondary text-sm lg:text-base max-w-md">
            {subtitle}
          </p>
          {onButtonClick && (
            <button
