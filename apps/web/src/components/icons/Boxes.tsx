...
const Boxes = ({
  ...
  return (
    <div style={{ display: "flex", alignItems: "center", justifyContent: "center" }}>
      ...
      >
        <motion.path d="M2.97 12.92A2 2 0 0 0 2 14.63v3.24a2 2 0 0 0 .97 1.71l3 1.8a2 2 0 0 0 2.06 0L12 19v-5.5l-5-3-4.03 2.42Z" variants={pathVariants} animate={controls} />
        ...
        <motion.path d="M12 13.5V19l3.97 2.38a2 2 0 0 0 2.06 0l3-1.8a2 2 0 0 0 .97-1.71v-3.24a2 2 0 0 0-.97-1.71L17 10.5l-5 3Z" variants={pathVariants} animate={controls} />
        ...
        <motion.path d="M7.97 4.42A2 2 0 0 0 7 6.13v4.37l5 3 5-3V6.13a2 2 0 0 0-.97-1.71l-3-1.8a2 2 0 0 0-2.06 0l-3 1.8Z" variants={pathVariants} animate={controls} />
