...
export const NavLink = React.memo<NavLinkProps>(({ icon: Icon, label, active, isDark, onClick, borderGradient }) => {
  ...
  const content = (
    <>
      ...
      <span data-nav-label="true" className="relative z-[2]" style={{ fontFamily: "'Lato', sans-serif", fontWeight: 700, fontSize: '15px', letterSpacing: '0.06em' }}>
    ...
    return (
      ...
      >
        <span className="relative z-[1]" style={{ flexShrink: 0, transition: 'color 0.3s ease' }}>
          <Icon width={20} height={20} stroke={hoverTextColor} strokeWidth={2} isHovered={isHovered} />
        </span>
        <span className="relative z-[1]" style={{ fontFamily: "'Lato', sans-serif", fontWeight: 700, fontSize: '15px', letterSpacing: '0.06em', color: hoverTextColor, transition: 'color 0.3s ease' }}>
